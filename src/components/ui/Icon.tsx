...
/*
  Sistema de íconos de línea (reemplaza los emojis del diseño anterior).
  Trazos estilo Lucide (MIT). Uso:
    <Icon name="pill" size={20} />
    <Icon name="alert" color="var(--red)" />
*/

export type IconName =
  | 'home' | 'clipboard' | 'pill' | 'flask' | 'alert' | 'syringe' | 'user'
  | 'qr' | 'heart' | 'drop' | 'calendar' | 'clock' | 'plus' | 'logout'
  | 'bell' | 'search' | 'chevron' | 'file' | 'phone' | 'check';
...
export function Icon({ name, size = 20, color = 'currentColor', strokeWidth = 1.7, style }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
